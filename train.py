...
def train(config):
	...
	for epoch in range(config.num_epochs):
		...
		for iter_val, (img_orig, img_haze) in enumerate(val_loader):
			...
			torchvision.utils.save_image(torch.cat((img_haze, clean_image, img_orig),0), config.sample_output_folder+str(iter_val+1)+".png")
...
if __name__ == "__main__":
	...
	# Input Parameters
	parser.add_argument('--orig_images_path', type=str, default="MyHazeDataset/CleanImg0/")
	parser.add_argument('--hazy_images_path', type=str, default="MyHazeDataset/HazeImg0/")
